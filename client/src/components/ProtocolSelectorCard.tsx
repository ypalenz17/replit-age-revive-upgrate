  ...
  return (
    ...
    >
      <div
        ...
        style={{
          background: `radial-gradient(300px 300px at 50% 40%, ${hexToRgba(badgeColor, 0.15)}, transparent 70%)`,
        }}
      />
      ...
      <div className="relative z-10 w-full flex flex-col items-center">
        <div className="w-full flex items-center justify-center -mx-3">
          <img
            src={p.image}
            alt={p.name}
            className="w-[92%] h-auto max-h-[360px] object-contain group-hover:scale-105 transition-transform duration-500"
