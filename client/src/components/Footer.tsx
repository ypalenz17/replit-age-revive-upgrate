      ...
      <div className="max-w-2xl mx-auto">
        <div className="grid grid-cols-3 gap-6 md:gap-10">
          <div className="flex flex-col gap-2">
            <span className="text-[9px] font-mono font-bold text-white/35 uppercase tracking-[0.12em] mb-1">System</span>
          ...
          <div className="flex flex-col gap-2">
            <span className="text-[9px] font-mono font-bold text-white/35 uppercase tracking-[0.12em] mb-1">Science</span>
