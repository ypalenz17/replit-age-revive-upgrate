    ...
    >
      <div className="flex items-center justify-between px-5 py-3 gap-4 safe-bottom">
        <div className="min-w-0">
          <p className="font-mono text-[10px] uppercase tracking-[0.10em] text-white/45 truncate">CELLUNOVA</p>
...
export default function CellunovaPDP({ data, slug }: { data: ProductDetailData; slug: string }) {
  ...
  return (
    <div ref={containerRef} className="min-h-screen font-sans antialiased selection:bg-teal-400/20 selection:text-white" style={{ backgroundColor: BASE_DARK }}>
            ...
            <div className="lg:sticky lg:top-20 space-y-4 lg:space-y-5 pt-5 lg:pt-0 pb-8 lg:pb-0">
              <div className="space-y-2 lg:space-y-3">
                <div className="flex items-center gap-3">
                  <p className="font-mono text-[10px] lg:text-[11px] uppercase tracking-[0.14em] text-ar-teal">7-Day Periodic Protocol</p>
                  <span className="px-2 py-0.5 rounded text-[9px] font-mono font-bold uppercase tracking-[0.06em] bg-ar-teal/10 text-ar-teal border border-ar-teal/20" data-testid="protocol-badge">Monthly Cycle</span>
                </div>
              ...
              <p className="text-[14px] lg:text-[15px] text-white/55 font-sans leading-relaxed max-w-md">
                A focused 7-day cycle with autophagy and senolytic research compounds for periodic cellular renewal support. Not a daily supplement — a structured monthly protocol.*
              </p>

              <div className="flex flex-wrap gap-2">
                <span className="text-[10px] font-mono uppercase tracking-[0.06em] px-2.5 py-1.5 rounded-md text-white/55 bg-white/[0.05] border border-white/[0.07]">7-Day Protocol</span>
                <span className="text-[10px] font-mono uppercase tracking-[0.06em] px-2.5 py-1.5 rounded-md text-white/55 bg-white/[0.05] border border-white/[0.07]">Monthly Cycle</span>
              ...
              <div className="space-y-2 pt-1">
                <div className="flex items-baseline gap-3">
                  ...
                  <span className="text-[12px] text-white/30 font-mono uppercase tracking-[0.06em]">per cycle</span>
                </div>
                <div className="flex items-center gap-2">
              ...
              <div className="pt-3 border-t border-white/[0.06] space-y-2">
                <div className="grid grid-cols-2 gap-x-3 gap-y-1.5">
                  {['Full label disclosure', 'Third-party tested', 'No proprietary blends', 'Contains wheat'].map((label) => (
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-3 md:gap-4">
            {[
              ...
              { title: 'Contains Wheat', desc: 'Spermidine is derived from wheat germ. See allergen note below.' },
          ...
          <div className="mt-6 bg-white rounded-lg px-5 py-4 border border-[#0A1220]/[0.05]" style={{ boxShadow: '0 1px 2px rgba(10,18,32,0.03)' }}>
            <p className="text-[12px] font-sans text-[#0A1220]/50 leading-[1.6]">
              <span className="font-semibold text-[#0A1220]/70">Safety note:</span> Consult your healthcare provider before use if you are pregnant, nursing, on medication, or managing a medical condition. Contains wheat (from wheat germ derived spermidine).
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            {[
              ...
              'Those running structured protocols who want a dedicated reset cycle',
              'People who already take a daily NAD+ or gut-support product and want to layer periodic support',
          ...
          <div className="mt-6 px-5 py-4 rounded-lg border border-white/[0.06]" style={{ backgroundColor: 'rgba(255,255,255,0.02)' }}>
            <p className="text-[12px] font-sans text-white/35 leading-[1.6]">
              <span className="font-semibold text-white/50">Not ideal for:</span> Those looking for a daily baseline product. CELLUNOVA is a periodic protocol — not a daily supplement. If you are starting out, consider CELLUNAD+ as your daily foundation first.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="cv-reveal py-[72px] md:py-[110px] px-6 md:px-8" style={{ backgroundColor: LIGHT }}>
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-5">
            {[
              { title: 'Periodic Protocol Format', body: 'CELLUNOVA is a structured 7-day cycle repeated monthly — not a diluted daily dose. The rest period between cycles is part of the design.' },
              ...
              { title: 'Multi-Pathway Coverage', body: 'Autophagy support, senescence research compounds, and mitochondrial resilience compounds — three layers in one protocol, not one compound stretched thin.' },
              { title: 'System-Aware Design', body: 'Built to layer onto daily CELLUNAD+ or CELLUBIOME support. The periodic format means it complements rather than conflicts with your daily routine.' },
            ].map((card, i) => (
              <div
                key={i}
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-3">
            {(data.ingredientGroups || []).map((group, i) => (
              <div
                key={i}
                className="bg-white/[0.02] rounded-xl p-6 md:p-7 border border-white/[0.05]"
          ...
          <div className="bg-white rounded-xl border border-[#0A1220]/[0.06] overflow-hidden" style={{ boxShadow: '0 1px 3px rgba(10,18,32,0.04)' }}>
            ...
            <div className="px-6 md:px-8 py-4 border-t border-[#0A1220]/[0.06] bg-[#0A1220]/[0.015]">
              ...
              {data.supplementFacts.allergenNote && (
                <p className="text-[11px] font-sans text-[#0A1220]/45 font-semibold mt-1">Allergen: {data.supplementFacts.allergenNote}</p>
              )}
            </div>
          </div>
      ...
      {/* ─── MID-PAGE CTA — SECONDARY_DARK ─── */}
      <section className="py-[56px] md:py-[72px] px-6 text-white" style={{ backgroundColor: SECONDARY_DARK }}>
      ...
      {(() => {
        ...
        return (
          <section className="cv-reveal py-[72px] md:py-[110px] px-6 md:px-8 text-white" style={{ backgroundColor: BASE_DARK }}>
            <div className="max-w-3xl mx-auto">
              <div className="text-center mb-10 md:mb-14">
      ...
      <section className="cv-reveal py-[72px] md:py-[110px] px-6 md:px-8 text-white" style={{ backgroundColor: SECONDARY_DARK }}>
        <div className="max-w-3xl mx-auto">
          <div className="text-center space-y-3 mb-10">
            <span className="font-mono text-[10px] md:text-[11px] text-ar-teal/80 uppercase tracking-[0.20em]">Protocol Effects Over Time</span>
          ...
          <div className="bg-white rounded-xl border border-[#0A1220]/[0.06] overflow-hidden" style={{ boxShadow: '0 1px 3px rgba(10,18,32,0.04)' }}>
            <div className="grid grid-cols-2">
              ...
              <div className="px-5 md:px-7 py-4 border-b border-[#0A1220]/[0.06] border-l border-[#0A1220]/[0.06]">
                <span className="font-mono text-[11px] font-bold uppercase tracking-[0.10em] text-[#0A1220]/25">Generic Blends</span>
              </div>
            </div>
            <div className="grid grid-cols-2">
      ...
      <section className="cv-reveal py-[72px] md:py-[110px] px-6 md:px-8 text-white" style={{ backgroundColor: SECONDARY_DARK }}>
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-10 md:mb-12">
            ...
            <p className="mt-3 text-[13px] text-white/35 font-sans">CELLUNOVA is a periodic layer. These are the daily products it complements.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {data.stack.map((item, i) => (
              <div
                key={i}
                className="cv-reveal rounded-xl p-6 md:p-7 space-y-3 border border-white/[0.05] hover:border-white/[0.10] transition-colors"
                style={{ backgroundColor: '#15202F' }}
              >
