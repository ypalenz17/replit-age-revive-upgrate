...
export default function CellunadPDP({ data, slug }: { data: ProductDetailData; slug: string }) {
  ...
  return (
    <div ref={containerRef} className="min-h-screen font-sans antialiased selection:bg-teal-400/20 selection:text-white" style={{ backgroundColor: BASE_DARK }}>
        ...
        <div className="max-w-3xl mx-auto">
          <div className="text-center mb-10 md:mb-12">
            ...
            <p className="mt-4 text-[14px] text-white/40 font-sans leading-relaxed max-w-[480px] mx-auto">
              NAD+ supports cellular energy, DNA maintenance, and metabolic resilience. It declines with age. CELLUNAD+ is designed to support that pathway every day.
            </p>
          </div>
      ...
      <section className="cn-reveal py-[72px] md:py-[110px] px-6 md:px-8 text-white" style={{ backgroundColor: SECONDARY_DARK }}>
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-10 md:mb-14">
            <span className="font-mono text-[10px] md:text-[11px] text-ar-teal/80 uppercase tracking-[0.20em]">What Makes It Different</span>
            <h2 className="mt-3 font-head font-normal tracking-[-0.03em] uppercase text-white leading-[0.95]" style={{ fontSize: 'clamp(1.4rem, 3.5vw, 2.2rem)' }}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-5">
            {[
              ...
              { title: 'Methylation Co-Factor Support', body: 'NAD+ metabolism interacts with methylation pathways. Includes TMG, P-5-P, 5-MTHF, and Methylcobalamin to keep these pathways balanced.' },
              { title: 'Mitochondrial Cofactor Support', body: '200 mg R-Lipoic Acid supports mitochondrial oxidative balance. 100 mg Apigenin supports NAD+ conservation. Most NR products skip both.' },
              ...
              >
                <h3 className="text-[15px] md:text-[16px] font-head font-normal uppercase tracking-[-0.01em] text-white/90">{card.title}</h3>
                <p className="mt-3 text-[13px] font-sans text-white/45 leading-[1.6]">{card.body}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      {/* ─── 6. FORMULA ARCHITECTURE — LIGHT ─── */}
      <section className="cn-reveal py-[72px] md:py-[110px] px-6 md:px-8" style={{ backgroundColor: LIGHT }}>
        <div className="max-w-3xl mx-auto">
          <div className="text-center mb-10 md:mb-12">
            <span className="font-mono text-[10px] md:text-[11px] text-ar-teal uppercase tracking-[0.20em]">Formula Architecture</span>
            <h2 className="mt-3 font-head font-normal tracking-[-0.03em] uppercase leading-[0.95]" style={{ fontSize: 'clamp(1.4rem, 3.5vw, 2.4rem)', color: BASE_DARK }}>
              Why NR alone is not the whole story.
            </h2>
            <p className="mt-4 text-[13px] text-[#0A1220]/45 font-sans leading-relaxed max-w-[500px] mx-auto">
              Most NAD+ products deliver NR by itself. CELLUNAD+ pairs it with the co-factors your cells need to metabolize NAD+ efficiently.
            </p>
          </div>
            ...
            {[
              ...
              >
                <div className="flex flex-col sm:flex-row sm:items-baseline sm:justify-between gap-1 sm:gap-4 mb-2">
                  <h4 className="text-[15px] font-head font-normal uppercase tracking-[-0.01em]" style={{ color: BASE_DARK }}>{item.layer}</h4>
                  <span className="font-mono text-[10px] text-ar-teal tracking-[0.06em] shrink-0">{item.compound}</span>
                </div>
                <p className="text-[13px] font-sans text-[#0A1220]/45 leading-[1.6]">{item.why}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      {/* ─── 7. SUPPLEMENT FACTS — SECONDARY_DARK ─── */}
      <section className="cn-reveal py-[72px] md:py-[110px] px-6 md:px-8 text-white" style={{ backgroundColor: SECONDARY_DARK }}>
        <div className="max-w-3xl mx-auto">
          <div className="text-center mb-10 md:mb-12">
            <span className="font-mono text-[10px] md:text-[11px] text-ar-teal/80 uppercase tracking-[0.20em]">Supplement Facts</span>
          ...
          <div className="text-center mt-6">
            <button
              onClick={() => setIsFactsOpen(true)}
              className={`text-[11px] font-mono uppercase tracking-[0.10em] text-white/30 hover:text-white/55 transition-colors ${focusRing} rounded px-2`}
      ...
      {/* ─── MID-PAGE CTA — LIGHT ─── */}
      <section className="py-[56px] md:py-[72px] px-6" style={{ backgroundColor: LIGHT }}>
      ...
      {(() => {
        ...
        return (
          <section className="cn-reveal py-[72px] md:py-[110px] px-6 md:px-8 text-white" style={{ backgroundColor: BASE_DARK }}>
            <div className="max-w-3xl mx-auto">
              <div className="text-center mb-10 md:mb-14">
      ...
      {/* ─── 10. RESULTS OVER TIME — SECONDARY_DARK ─── */}
      <section className="cn-reveal py-[72px] md:py-[110px] px-6 md:px-8 text-white" style={{ backgroundColor: SECONDARY_DARK }}>
        <div className="max-w-3xl mx-auto">
      ...
      {/* ─── 12. PAIRS WELL WITH — SECONDARY_DARK ─── */}
      <section className="cn-reveal py-[72px] md:py-[110px] px-6 md:px-8 text-white" style={{ backgroundColor: SECONDARY_DARK }}>
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-10 md:mb-12">
            ...
            <p className="mt-3 text-[13px] text-white/35 font-sans">Start with CELLUNAD+. Add more when you are ready.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {data.stack.map((item, i) => (
              <div
                key={i}
                className="cn-reveal rounded-xl p-6 md:p-7 space-y-3 border border-white/[0.05] hover:border-white/[0.10] transition-colors"
                style={{ backgroundColor: '#15202F' }}
              >
