...
## Brand
Age Revive is a premium longevity supplements brand.
The site must feel luxurious, clinically informed, restrained, trustworthy, and easy to buy from.
...
- neuron or brain-node graphics
- circuit board motifs
- glowing particles
- AI-themed visuals
- cybernetic or transhuman imagery
- biotech cliche graphics
- stock medical icons as decoration
- decorative icon sets that add no meaning
- glassmorphism
- holographic UI
- overblown shadows
- random gradients
...
Default to zero icons unless an icon is clearly necessary for comprehension.
...
Use concise, evidence-aware, premium language instead.
Support-oriented wording is preferred over hype.

## Homepage priorities
1. Make it immediately clear what Age Revive sells
2. Make it obvious where a first-time customer should start
3. Surface trust within the first scrolls
4. Make product roles easy to understand
5. Strengthen CTA hierarchy
6. Improve section separation
7. Preserve scientific sophistication without overwhelming the visitor
8. Make mobile exceptionally clean and easy to scan

## Required section rhythm
The page must not feel like one long dark slab.

Use this background system:
- Base dark: #0A1220
- Secondary dark: #101B2D
- Light clinical: #F4F1EA
- Accent: existing mint/teal only

Use these to create a rhythm like:
dark -> lifted dark -> light -> dark -> light -> dark

Use tonal shifts, spacing, card surfaces, and section markers to create real chapter breaks.
...
Visitors should understand the 3-product system in under 5 seconds.

Each key product card must clearly show:
- product name
- what it is best for
- cadence
- price
...
Favor clarity over mechanism-heavy language in upper sections.

## UI rules
Use:
- tonal section separation
- refined spacing
- subtle borders
- stronger card/background contrast
- elegant button hierarchy
- restrained elevation
- crisp typography hierarchy

Do not solve design problems with:
- more colors
- more icons
- more decoration
- more animation
...
- 100px to 120px top and bottom

Mobile section padding:
- 72px to 88px top and bottom
...
- surface trust early
- make the product system easy to understand
- have strong CTA hierarchy
...
## CELLUNOVA product page rules

This is a top-priority product page and one of the most compliance-sensitive pages on the site.
It must feel premium, credible, restrained, and extremely clear.

### Core positioning
CELLUNOVA should be presented as a premium periodic protocol layer.
It must not be presented like:
- a daily baseline product
- a generic supplement PDP
- a science essay
- a biotech fantasy page
- a protocol-builder first
- a one-size-fits-all product

### What the page must answer fast
1. What is CELLUNOVA?
2. Is it a daily product or a periodic protocol?
3. Who is it best for?
4. Who is it not for?
5. Why is it different from generic "autophagy" or "senolytic" blends?
6. Why should I trust it?
7. How do I use it?
8. How does it fit into the broader Age Revive system?

### Core strategy
This page must convert with honesty.
It should feel like a premium periodic protocol page built for intelligent buyers, not hype-driven supplement marketing.
...
- futuristic biotech styling
- glowing particles
- sci-fi gradients
- zombie cell cartoons
- generic wellness icon packs
...
- AI fluff
- biotech hype
- exaggerated senolytic claims
- drug-like language
- "zombie cells" language
- overconfident anti-aging promises
- vague futurist phrasing

Use calm, evidence-aware, support-oriented language.

### Hard consistency rules
- Do not let this page inherit copy from other product pages
- Remove any leftover language that suggests this is a daily baseline product if that language appears
- Remove any leftover language that suggests this product is enteric-protected if that language appears
- Remove any leftover language that suggests the wrong serving or cadence if that language appears
- Do not let protocol-stack UI dominate a single-product landing page
- The sticky mobile CTA must be product-specific, not a generic protocol-stack bar
- If approved product content includes allergen or clinician-consult notes, surface them clearly before deep scroll
- If approved product content positions this as a periodic layer rather than the default starting product, that must be clear throughout the page
- Do not present senescence/autophagy language more aggressively than approved site content supports
...
- Secondary dark: #101B2D
- Light clinical: #F4F1EA
- Existing primary accent only

Create real chapter breaks with:
- tonal shifts
- spacing
- card surfaces
...
### Product page priorities
1. Product-truth consistency
2. Strong hero and buy box
3. Early trust
4. Clear periodic-protocol positioning
5. Clear "who it's for" guidance
6. Stronger differentiation
7. Cleaner mobile sticky buy behavior
8. Better section separation
9. Better science hierarchy
10. Stronger premium feel
...
## Shop / Shop All page rules

This page is not a generic catalog.
It must behave like a guided selector, comparison page, and premium protocol builder.

### Core job
Help a new visitor understand the 3-product system in seconds:
- what each product does
- who should start where
- how each product fits into the protocol
- what each one costs
- how often each one is used
- what should be bought together

### What this page must do fast
1. Make the system easy to understand
2. Make it obvious where most people should start
3. Make the differences between the 3 products instantly clear
4. Make price and cadence visible without extra scrolling
5. Surface trust proof early
6. Make buying one product or the full system easy
7. Feel premium and highly intentional on mobile

### Core strategy
This page must not feel like 3 mini landing pages stacked vertically.
It must feel like:
- a guided selector
- a premium comparison page
- a clear protocol builder
- a fast decision page
...
- gene or chromosome imagery
- molecule graphics
- neural/circuit/AI visuals
- biotech cliché motifs
- decorative icon clutter
- glassmorphism
- loud gradients
- generic startup SaaS design
- generic ecommerce template styling
- carousels that hide important product info
- meaningless graphics or stock wellness filler

Default to zero icons unless they clearly improve comprehension.

### Copy rules
Do not use hype or AI fluff.
Do not introduce language like:
- revolutionary
- next-gen
- cutting-edge
- optimize your biology
...
### Product-truth rules
Use current approved product content as source of truth for:
- pricing
- cadence
- serving
- ingredient anchors
- product role
- warnings / allergen notes
- protocol guidance

Do not let the shop page create contradictions with:
- FAQ
- product pages
- quality page
- science page
...
- Do not treat all 3 products as equally likely starting points
- Surface "most people start here" guidance clearly
- Do not hide price
- Do not hide cadence
- Do not hide key product differences
- Do not let "View Protocol" be the only meaningful action
- Do not make "Add to Stack" the default language if a clearer action is better
- If bundle or system pricing is shown, compute from real current product prices only
- Never invent discounts or savings that do not actually exist
...
Create real section rhythm:
dark -> light -> dark -> light -> dark

Do not let the page feel like one long dark slab.

### Product card rules
Each product card must clearly show:
- product name
- role in the system
- best for
- cadence
- price
- supply
- 2 to 3 meaningful ingredient or benefit anchors
- one clear primary action
- one clear secondary action if needed

Packaging details like glass bottle or UV protection must be secondary, not primary.
...
It must feel like premium scientific documentation for intelligent buyers, not a generic marketing page and not an academic wall of text.

### Core job
The science page should help a visitor quickly understand:
- what this page is
- how to read the evidence
- how the 3-product system is structured
- why each formula exists
- what standards Age Revive uses
- what confidence level to place on different ingredients and claims
- where to go next
...
This page should reduce skepticism and support premium pricing by making the brand feel:
- careful
- transparent
- evidence-aware
- restrained
...
- a generic biotech site
- a fake scientific dashboard
- a wall of dark cards
- a pile of PubMed citations with no hierarchy
- a page that oversells early-stage evidence

### Absolutely forbidden
Never introduce:
- DNA helix icons
- gene or chromosome imagery
- molecule graphics unless strictly functional and genuinely explanatory
- neural/circuit/AI motifs
- decorative charts or fake data visualizations
- generic biotech motifs
- stock medical icon clutter
- glassmorphism
- holographic UI
- loud gradients
- decorative chips that add no real meaning
- zombie-cell visuals
- meaningless "scientific" art
...
- language that makes all ingredients sound equally proven

Use calm, concise, evidence-aware, premium language.

### Hard evidence rules
- Preserve and strengthen scientific nuance
- Do not flatten evidence levels
- Do not imply mechanistic, observational, in vitro, preclinical, and human outcomes are the same
- Do not remove caveats that currently make the page more credible
- Keep "educational, not medical advice" language visible
- Keep "references are transparency, not promises" logic visible
- Make standards and boundaries easier to understand, not weaker

### Mobile evidence rules
Evidence tables must not become cramped or horizontally unreadable on mobile.

Required:
- desktop can use structured tables
- mobile must use stacked cards, accordions, or other readable responsive layouts
- no cutoff columns
- no tiny compressed scientific text
- no exhausting endless repeated rows with weak hierarchy

### References rules
References must be usable, not just present.

Required:
- group references logically
- make them easy to scan
- make them clearly linked
- show why each reference matters
- keep citation presentation elegant and mobile-readable

### CTA rules
This page is not a hard-sell page.
Keep CTA usage disciplined.

Allowed:
- one strong hero CTA to jump into evidence or browse the system
- one restrained final CTA to shop or build the protocol
- limited product-specific CTAs in the architecture section if necessary

Not allowed:
- repeated sales CTAs after every section
- CTA clutter
- science page behaving like a product detail page

### Visual rules
This page can and should be more documentation-like than the homepage.
...
4. Standards and delivery logic
5. Evidence and dosing by product
6. Glossary
7. FAQ
8. References
